...
const WritingConfigModal: React.FC<WritingConfigModalProps> = ({ open, onConfirm, onCancel }) => {
    ...
    >
      <Spin spinning={loadingResources}>
        <div style={{ maxHeight: '70vh', overflowY: 'auto', padding: '16px 0' }}>
          ...
          >
            <Collapse defaultActiveKey={['resources', 'parameters']}>
...
export default WritingConfigModal;
